...
pub fn PlanetaryScienceQapp() -> Element {
    ...
    let body_types = [
        "Terrestrial Planet", "Gas Giant", "Ice Giant", "Dwarf Planet",
        "Moon", "Asteroid", "Comet", "Trans-Neptunian Object",
    ];
    let planets = [
    ...
    let atmospheres = [
        "None", "Thin CO2", "Thick CO2", "N2-O2", "H2-He",
        "Methane-N2", "Thick SO2",
    ];
    let features = [
        "Impact Crater", "Volcano", "Canyon", "Ice Cap",
        "Ocean", "Desert", "Mountain Range",
    ];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Planetary Science" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Body Type" }
                    select {
                        value: "{body_type}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Planet / Target" }
                    select {
                        value: "{planet}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Atmosphere Type" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Surface Feature" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Orbital Period (days)" }
                    input {
                        r#type: "number",
                        step: "0.01",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Distance (AU)" }
                    input {
                        r#type: "number",
                        step: "0.01",
                        value: "{distance_au}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{planet} ({body_type}) | {atmosphere_type} | {orbital_period_days:.2}d | {distance_au:.2}AU" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → orbital mechanics engine | planetary geology sieve | solar system graph" }
            }
        }
    }
}
