...
pub fn PostcolonialStudiesQapp() -> Element {
    ...
    let traditions = [
        "Said Orientalism", "Spivak Subaltern", "Bhabha Hybridity", "Fanon",
        "Négritude", "Decolonial Turn", "Settler Colonialism", "World-Systems",
    ];
    let empires = [
        "British", "French", "Portuguese", "Spanish", "Dutch", "Belgian",
        "German", "Ottoman", "Japanese", "American", "Soviet",
    ];
    let lenses = [
        "Literature", "History", "Anthropology", "Political Economy",
        "Legal", "Film", "Architecture",
    ];
    let frames = [
        "High Colonialism", "Late Colonial", "Independence", "Neo-Colonial", "Contemporary",
    ];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #eba0ac; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Postcolonial Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Colonial Empire" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Time Frame" }
                    select {
                        value: "{time_frame}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{theoretical_tradition} | {colonial_empire} | {disciplinary_lens} | {time_frame}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → subaltern sieve | hybridity graph | decolonial theory engine" }
            }
        }
    }
}
