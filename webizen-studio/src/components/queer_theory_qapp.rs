...
pub fn QueerTheoryQapp() -> Element {
    ...
    let orientations = ["Butlerian Performativity", "Anti-Normativity", "Queer Temporality", "Queer of Color Critique", "Crip Queer", "Trans Studies"];
    let theorists = ["Butler", "Sedgwick", "Muñoz", "Puar", "Halberstam", "Crenshaw", "Spade"];
    let sites = ["Identity", "Body", "Temporality", "Space", "Law", "Family", "Affect"];
    let strategies = ["Parody", "Camp", "Failure", "Futurity", "Coalition", "Refusal"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #b4befe; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Queer Theory" }
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Theoretical Orientation" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Subversion Strategy" }
                select {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{key_theorist} | {theoretical_orientation} | {subversion_strategy} | Critique: {normativity_critique}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → queer theory engine | performativity sieve | normativity anchor" }
            }
        }
    }
}
