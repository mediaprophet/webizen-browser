...
pub fn FanStudiesQapp() -> Element {
    ...
    let lenses = ["Participatory Culture (Jenkins)", "Textual Poaching", "Affect Theory", "Fan Labour", "Queer Fan Studies", "Fandom as Subculture", "Digital Ethnography"];
    let fandom_types = ["Sci-Fi", "Fantasy", "Anime", "K-Pop", "Sports", "Gaming", "True Crime", "Celebrity"];
    let platforms = ["Fanfiction.net", "AO3", "Tumblr", "Twitter", "Reddit", "Discord", "TikTok", "YouTube"];
    let practices = ["Fanfiction", "Fanart", "Vidding", "Cosplay", "Fan Wiki", "Meta-Commentary", "Shipping"];
    let engagement_levels = ["Lurker", "Casual", "Core", "BNF"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #f38ba8; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Fan Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Fandom Type" }
                    select {
                        value: "{fandom_type}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Fan Practice" }
                    select {
                        value: "{fan_practice}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Engagement Level" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Community Size: {community_size}" }
                input {
                    r#type: "range",
                    min: "100",
                    max: "1000000",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{fandom_type} | {platform} | {fan_practice} | {engagement_level} | n={community_size}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → fan culture engine | participatory media sieve | community anchor" }
            }
        }
    }
}
