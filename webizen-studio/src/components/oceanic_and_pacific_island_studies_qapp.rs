...
pub fn OceanicAndPacificIslandStudiesQapp() -> Element {
    ...
    let regions = [
        "Polynesia", "Melanesia", "Micronesia", "Australia", "Aotearoa NZ",
        "Hawaiian Islands", "Guam", "Fiji", "PNG", "Oceania-Wide",
    ];
    let lenses = [
        "History", "Anthropology", "Literature", "Environmental",
        "Political Self-Determination", "Language Revitalisation", "Indigenous Knowledge",
    ];
    let powers = [
        "British", "French", "American", "German", "Japanese", "Spanish", "Independent",
    ];
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: #94e2d5; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Oceanic & Pacific Island Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Colonial Power" }
                    select {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{region} | {disciplinary_lens} | {colonial_power} | {period}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → indigenous knowledge engine | decolonisation graph | language revitalisation sieve" }
            }
        }
    }
}
