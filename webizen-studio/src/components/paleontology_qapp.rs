...
pub fn PaleontologyQapp() -> Element {
    ...
    let fossil_types = ["Body Fossil", "Trace Fossil", "Molecular Fossil", "Exceptional Preservation", "Compression", "Cast & Mould"];
    let taxonomic_groups = ["Dinosauria", "Marine Reptile", "Pterosauria", "Mammal", "Trilobite", "Graptolite", "Plant", "Microfossil", "Early Hominid"];
    let geological_periods = ["Cambrian", "Ordovician", "Silurian", "Devonian", "Carboniferous", "Permian", "Triassic", "Jurassic", "Cretaceous", "Paleogene", "Neogene"];
    let preservation_qualities = ["Exceptional", "Good", "Fragmentary", "Poor"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #f9e2af; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Paleontology" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Fossil Type" }
                    select {
                        value: "{fossil_type}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Preservation Quality" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Age (Mya): {age_mya:.1}" }
                input {
                    r#type: "range",
                    min: "0",
                    max: "600",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Locality" }
                input {
                    r#type: "text",
                    value: "{locality}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{fossil_type} | {taxonomic_group} | {geological_period} | {age_mya:.0}Mya | {preservation_quality}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → palaeontological engine | stratigraphic sieve | taxonomic anchor" }
            }
        }
    }
}
