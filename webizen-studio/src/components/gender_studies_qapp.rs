...
pub fn GenderStudiesQapp() -> Element {
    ...
    let theoretical_frameworks = ["Liberal Feminism", "Radical Feminism", "Socialist Feminism", "Poststructuralist", "Intersectionality", "Queer Theory", "Trans Studies"];
    let gender_dimensions = ["Identity", "Expression", "Performance", "Embodiment", "Labour", "Violence", "Representation"];
    let methodologies = ["Discourse Analysis", "Ethnographic", "Survey", "Archival", "Autoethnographic"];
    let sites = ["Workplace", "Family", "Media", "Law", "Medicine", "Education", "Digital"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Gender Studies" }
            div {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Gender Dimension" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Gender Equity Index: {gender_equity_index}" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{theoretical_framework} | {gender_dimension} | {methodology} | {site} | equity: {gender_equity_index}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → gender studies engine | discourse sieve | anchor" }
            }
        }
    }
}
