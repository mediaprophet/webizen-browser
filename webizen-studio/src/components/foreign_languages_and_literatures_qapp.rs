...
pub fn ForeignLanguagesAndLiteraturesQapp() -> Element {
    ...
    let languages = ["Arabic", "Mandarin Chinese", "French", "German", "Italian", "Japanese", "Korean", "Portuguese", "Russian", "Spanish", "Swahili", "Turkish", "Hindi", "Persian (Farsi)", "Ancient Greek", "Latin", "Hebrew", "Dutch", "Swedish", "Polish"];
    let registers = ["Literary / Formal", "Colloquial / Everyday", "Academic / Technical", "Sacred / Liturgical", "Journalistic", "Legal / Official"];
    let periods = ["Ancient / Classical", "Medieval", "Early Modern (16th–17th C.)", "Enlightenment (18th C.)", "Romantic (19th C.)", "20th Century", "Contemporary"];
    let strategies = ["Foreignizing (Venuti)", "Domesticating (Nida)", "Literal / Interlinear", "Dynamic Equivalence", "Communicative", "Semantic", "Interpretive"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #94e2d5; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Foreign Languages & Literatures" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Register" }
                    select {
                        value: "{register}",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Source Text" }
                textarea {
                    value: "{source_text}",
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Translation Strategy" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Cultural Gloss / Annotation" }
                    input {
                        type: "text", placeholder: "Untranslatable terms, cultural context notes…",
            ...
            div {
                ...
                h3 { style: "margin-top: 0; color: #94e2d5; font-size: 0.9rem;", "Translation Analysis" }
                div { style: "font-size: 0.85rem; color: #cdd6f4;", "{source_lang} → {target_lang}" }
                div { style: "font-size: 0.8rem; color: #a6adc8; margin-top: 4px;",
                    "Strategy: {translation_strategy} | Register: {register} | Period: {period}"
                }
                if !cultural_gloss().is_empty() {
                    div { style: "font-size: 0.8rem; color: #f9e2af; margin-top: 4px;", "Cultural note: {cultural_gloss}" }
                }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 8px;", "QualiaDB → translation studies engine | lexical graph | neuro-symbolic sieve" }
            }
        }
    }
}
