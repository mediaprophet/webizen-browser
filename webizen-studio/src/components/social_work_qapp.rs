...
pub fn SocialWorkQapp() -> Element {
    ...
    let practice_levels = [
        "Micro", "Mezzo", "Macro", "Community Organising", "Policy Advocacy",
    ];
    let frameworks = [
        "Strengths-Based", "Trauma-Informed", "Systems Theory", "Ecological",
        "Feminist", "Anti-Oppressive", "Cognitive-Behavioural",
        "Psychodynamic", "Community Development",
    ];
    let populations = [
        "Children & Families", "Elderly", "People with Disabilities", "Refugees",
        "Homeless", "Addiction", "Mental Health", "Youth", "Veterans",
    ];
    let modalities = [
        "Case Management", "Group Work", "Community Development",
        "Advocacy", "Therapy", "Crisis Intervention",
    ];
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Social Work" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Practice Level" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Client Population" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Intervention Modality" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Risk Level" }
                    select {
                        value: "{risk_level}",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Burnout Risk (0–100): {burnout_risk}%" }
                input {
                    r#type: "range",
                    min: "0",
                    max: "100",
            ...
            div {
                ...
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Case Notes" }
                textarea {
                    value: "{case_notes}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{practice_level} | {theoretical_framework} | {client_population} | Risk: {risk_level} | Burnout: {burnout_risk}%" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → trauma-informed engine | risk assessment sieve | ecological systems graph" }
            }
        }
    }
}
