...
pub fn IslamicStudiesQapp() -> Element {
    ...
    let traditions = ["Sunni Hanafi", "Sunni Maliki", "Sunni Shafi'i", "Sunni Hanbali", "Shia Twelver", "Shia Ismaili", "Ibadi", "Sufi Orders", "Ahmadiyya", "Secular Muslim Thought"];
    let disciplines = ["Quran Studies", "Hadith", "Fiqh", "Kalam", "Sufism", "Islamic History", "Islamic Philosophy", "Islamic Political Thought", "Gender & Islam"];
    let periods = ["Prophetic", "Rashidun", "Umayyad", "Abbasid", "Medieval", "Ottoman", "Colonial", "Contemporary"];
    let methodologies = ["Textual", "Historical-Critical", "Anthropological", "Postcolonial", "Feminist"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Islamic Studies" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{tradition} | {discipline} | {historical_period} | {methodology}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → Islamic corpus engine | fiqh sieve | hadith anchor" }
            }
        }
    }
}
