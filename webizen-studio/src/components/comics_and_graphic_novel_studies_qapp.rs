...
pub fn ComicsAndGraphicNovelStudiesQapp() -> Element {
    ...
    let genres = ["Superhero", "Slice-of-Life", "Horror", "Sci-Fi", "Political", "Memoir", "Literary", "Manga", "Manhwa", "Bande Dessinée", "Webcomic"];
    let approaches = ["Narratology", "Semiotics", "Cultural Studies", "Feminist", "Postcolonial", "Industry Studies", "Reader Response"];
    let formal_elements = ["Panel Composition", "Gutters", "Speech Bubbles", "Colour", "Line Weight", "Page Turn", "Sequence"];
    let traditions = ["American Golden Age", "American Silver Age", "Bronze Age", "Indie", "Manga", "European BD", "Contemporary Global"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Comics & Graphic Novel Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Formal Element" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Creator or Work" }
                input {
                    r#type: "text",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{genre} | {tradition} | {theoretical_approach} | {formal_element}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → comics studies engine | sequential art sieve | formal element anchor" }
            }
        }
    }
}
