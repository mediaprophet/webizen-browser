...
pub fn LiberationStudiesQapp() -> Element {
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: var(--qualia-accent); border-bottom: 1px solid var(--qualia-border); padding-bottom: 8px;", "Liberation Studies" }
            div {
                label { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "Liberation Tradition" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "Oppression Structure" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "Liberation Index: {liberation_index}" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "{liberation_tradition} | {theorist} | {oppression_structure} | {praxis} | index: {liberation_index}" }
                div { style: "font-size: 0.75rem; color: var(--qualia-text-muted); margin-top: 6px;", "QualiaDB → liberation studies engine | discourse sieve | anchor" }
            }
        }
    }
}
