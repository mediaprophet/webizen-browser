...
pub fn MedicalHumanitiesQapp() -> Element {
    ...
    let domains = [
        "Literature & Medicine", "Narrative Medicine", "History of Medicine", "Bioethics",
        "Patient Experience", "Social Determinants", "Disability & Medicine",
        "Mental Health Narratives", "Visual Medicine",
    ];
    let periods = [
        "Ancient", "Medieval", "Early Modern", "19th C.", "20th C.", "Contemporary",
    ];
    let approaches = [
        "Close Reading", "Ethnography", "Discourse Analysis", "Archive",
        "Oral History", "Policy",
    ];
    let contexts = ["Hospital", "Primary Care", "Palliative", "Public Health", "Global"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Medical Humanities" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Clinical Context" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Condition or Topic" }
                input {
                    r#type: "text",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{domain} | {historical_period} | {methodological_approach} | {clinical_context}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → narrative medicine engine | clinical ethics sieve | patient experience graph" }
            }
        }
    }
}
