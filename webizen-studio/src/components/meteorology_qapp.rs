...
pub fn MeteorologyQapp() -> Element {
    ...
    let weather_systems = ["Anticyclone", "Cyclone", "Cold Front", "Warm Front", "Occluded Front", "Stationary Front", "Squall Line", "MCS", "Supercell", "Thunderstorm"];
    let forecast_methods = ["Numerical Weather Prediction", "Statistical", "Ensemble", "Analogue", "AI", "Nowcasting"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89dceb; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Meteorology" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Weather System" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Forecast Method" }
                    select {
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Pressure (hPa): {pressure_hpa:.0}" }
                    input {
                        r#type: "range",
                        min: "950",
                        max: "1050",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Wind Speed (kph): {wind_speed_kph:.0}" }
                    input {
                        r#type: "range",
                        min: "0",
                        max: "300",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Precipitation (mm): {precipitation_mm:.0}" }
                    input {
                        r#type: "range",
                        min: "0",
                        max: "500",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{weather_system} | {forecast_method} | {temperature_c:.0}°C | {pressure_hpa:.0}hPa | {wind_speed_kph:.0}kph" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → NWP engine | synoptic sieve | mesoscale anchor" }
            }
        }
    }
}
