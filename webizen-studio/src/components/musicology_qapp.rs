...
pub fn MusicologyQapp() -> Element {
    ...
    let subfields = ["Historical Musicology", "Systematic Musicology", "Cognitive Musicology", "Critical Musicology", "Computational Musicology"];
    let approaches = ["Formalism", "Hermeneutics", "New Musicology", "Feminist", "Postcolonial", "Empirical"];
    let repertoires = ["Medieval", "Renaissance", "Baroque", "Classical", "Romantic", "20th C. Art Music", "Jazz", "Popular", "World Music", "Electronic"];
    let methods = ["Schenkerian", "Set Theory", "Neo-Riemannian", "Topic Theory", "Style Analysis", "Corpus"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Musicology" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Repertoire" }
                    select {
                        value: "{repertoire}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Analytical Method" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Composer or Work" }
                input {
                    r#type: "text",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{subfield} | {theoretical_approach} | {repertoire} | {analytical_method}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → music corpus engine | harmonic analysis sieve | score anchor" }
            }
        }
    }
}
