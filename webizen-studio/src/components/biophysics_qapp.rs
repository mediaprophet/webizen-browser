...
pub fn BiophysicsQapp() -> Element {
    ...
    let subfields = [
        "Membrane Biophysics", "Single Molecule", "Motor Proteins",
        "Neuronal Electrophysiology", "Structural Biophysics",
        "Computational", "Systems Biophysics",
    ];
    let techniques = [
        "AFM", "Optical Tweezers", "Patch Clamp", "Cryo-EM",
        "FRET", "MD Simulation", "NMR", "X-ray Crystallography",
    ];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Biophysics" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Force (pN)" }
                    input {
                        r#type: "number",
                        step: "0.1",
                        value: "{force_pn}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Diffusion Coefficient (µm²/s)" }
                    input {
                        r#type: "number",
                        step: "0.01",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "kT Ratio (thermal energy)" }
                    input {
                        r#type: "number",
                        step: "0.1",
                        value: "{kt_ratio}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{subfield} | {technique} | F={force_pn:.1}pN | Vm={membrane_potential_mv:.0}mV | kT={kt_ratio:.1}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → molecular dynamics engine | force spectroscopy sieve | membrane physics graph" }
            }
        }
    }
}
