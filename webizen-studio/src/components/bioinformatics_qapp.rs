...
pub fn BioinformaticsQapp() -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                label { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "Data Type" }
                select {
                    value: "{data_type}",
            ...
            div {
                label { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "Sequence Length Range" }
                select {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: var(--qualia-text-muted);", "{analysis_type} | {algorithm} | {data_type} | {seq_length_range} | acc {accuracy}%" }
