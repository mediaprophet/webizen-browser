...
pub fn HumanRightsStudiesQapp() -> Element {
    ...
    let rights_categories = [
        ...
        "Environmental", "Collective", "Emerging Digital",
    ];
    let violations = [
        "Torture", "Extrajudicial Killing", "Arbitrary Detention", "Discrimination",
        "Statelessness", "Forced Displacement", "Child Labour", "Trafficking",
    ];
    let mechanisms = [
        "UN Treaty Body", "ICC", "Regional Court", "National NHR Institution",
        "NGO Advocacy", "Universal Periodic Review",
    ];
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: #f38ba8; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Human Rights Studies" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Rights Category" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Violation Type" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Enforcement Mechanism" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Severity (1–5): {severity}" }
                input {
                    r#type: "range",
                    min: "1",
                    max: "5",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{rights_category} | {violation_type} | {enforcement_mechanism} | Severity: {severity}/5" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → accountability graph | treaty body sieve | regime classification engine" }
            }
        }
    }
}
