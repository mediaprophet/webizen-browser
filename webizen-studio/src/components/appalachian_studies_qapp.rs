...
pub fn AppalachianStudiesQapp() -> Element {
    ...
    let subfields = ["History", "Literature", "Music", "Environmental Studies", "Labour History", "Material Culture", "Language", "Religion"];
    let periods = ["Pre-Settlement", "Colonial", "Industrial", "Post-Industrial", "Contemporary"];
    let themes = ["Coal Industry", "Poverty", "Stereotyping", "Cultural Resilience", "Queer Appalachia", "Migration", "Opioid Crisis", "Environmental Justice"];
    let methods = ["Oral History", "Ethnography", "Survey", "Archival", "Community-Based Research"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Appalachian Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Thematic Focus" }
                    select {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{subfield} | {period} | {thematic_focus} | {methodology}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → regional culture engine | oral history sieve | community archive" }
            }
        }
    }
}
