...
pub fn LiteratureAndLawQapp() -> Element {
    ...
    let analytical_modes = ["Law in Literature", "Law as Literature", "Law and Narrative", "Legal Semiotics", "Rhetoric of Law", "Justice Aesthetics"];
    let genres = ["Trial Narrative", "Legal Drama", "Prison Writing", "Human Rights Fiction", "Constitutional Text", "Courtroom Poetry"];
    let legal_concepts = ["Justice", "Rights", "Punishment", "Sovereignty", "Property", "Testimony"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89dceb; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Literature and Law" }
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Analytical Mode" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Legal Concept" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Narrative Justice: {narrative_justice}" }
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Rhetorical Power: {rhetorical_power}" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{analytical_mode} | {genre} | {legal_concept} | justice: {narrative_justice} | rhetoric: {rhetorical_power}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → literature and law engine | discourse sieve | anchor" }
            }
        }
    }
}
