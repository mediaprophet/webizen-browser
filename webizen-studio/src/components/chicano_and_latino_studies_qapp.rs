...
pub fn ChicanoAndLatinoStudiesQapp() -> Element {
    ...
    let communities = [
        "Chicano", "Mexican American", "Puerto Rican", "Dominican",
        "Cuban American", "Central American", "South American", "Mixed", "Pan-Latino",
    ];
    let lenses = [
        "Aztlán", "Border Theory (Anzaldúa)", "Testimonio", "LatCrit",
        "Decolonial", "Feminist", "Queer Latino",
    ];
    let periods = [
        "Colonial", "Bracero Era", "Civil Rights", "Immigration Reform", "DACA", "Contemporary",
    ];
    let regions = [
        "Southwest US", "Midwest", "Northeast", "Southeast", "Pacific",
    ];
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: #fab387; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Chicano & Latino Studies" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Community" }
                    select {
                        value: "{community}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{community} | {period} | {region} | {language}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → borderlands theory engine | testimonial sieve | decolonial graph" }
            }
        }
    }
}
