...
pub fn PlaywritingQapp() -> Element {
    ...
    let forms = ["One-Act", "Full-Length", "Ten-Minute", "Solo Show", "Musical Book", "Radio Play", "Screenplay Adaptation", "Verbatim"];
    let approaches = ["Well-Made Play", "Brechtian Epic", "Absurdist", "Aristotelian", "Non-Linear", "Devised"];
    let registers = ["Heightened", "Naturalistic", "Poetic", "Subtext-Heavy", "Presentational"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Playwriting" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Dramatic Form" }
                    select {
                        value: "{dramatic_form}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Structural Approach" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Dialogue Register" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Protagonist Drive" }
                    input {
                        r#type: "text",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Inciting Incident" }
                    input {
                        r#type: "text",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Central Tension" }
                    input {
                        r#type: "text",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Draft Pages: {draft_pages}" }
                input {
                    r#type: "range",
                    min: "0",
                    max: "150",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{dramatic_form} | {structural_approach} | {dialogue_register} | {draft_pages}pp" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → dramatic structure engine | dialogue analysis sieve | theatre anchor" }
            }
        }
    }
}
