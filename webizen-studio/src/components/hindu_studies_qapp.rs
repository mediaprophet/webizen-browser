...
pub fn HinduStudiesQapp() -> Element {
    ...
    let traditions = ["Vedanta", "Samkhya", "Yoga", "Nyaya", "Vaisheshika", "Mimamsa", "Shaivism", "Vaishnavism", "Shaktism", "Tantra", "Reform Hinduism"];
    let concepts = ["Brahman", "Atman", "Maya", "Karma", "Dharma", "Moksha", "Samsara", "Ahimsa"];
    let periods = ["Vedic", "Upanishadic", "Classical", "Medieval Bhakti", "Colonial", "Contemporary"];
    let approaches = ["Philological", "Anthropological", "Phenomenological", "Feminist", "Dalit Critique"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #fab387; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Hindu Studies" }
            ...
            div {
                ...
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → Hindu corpus engine | dharmic sieve | philosophical anchor" }
            }
        }
    }
}
