...
pub fn GameStudiesQapp() -> Element {
    ...
    let genres = [
        ...
        "Narrative", "Sports", "MMO", "Serious Game", "Pervasive",
    ];
    let approaches = [
        "Ludology", "Narratology", "New Media Studies", "Performance Studies",
        "Affect Theory", "Political Economy", "Queer Theory",
    ];
    let platforms = ["PC", "Console", "Mobile", "VR", "AR", "Board Game", "LARP"];
    let player_counts = ["Single", "Cooperative", "Competitive", "Massively Multiplayer"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #b4befe; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Game Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Player Count" }
                    select {
                        value: "{player_count}",
            ...
            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Mechanics Focus" }
                    input {
                        r#type: "text",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{genre} | {theoretical_approach} | {platform} | {player_count}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → ludic mechanics engine | media theory sieve | cultural graph" }
            }
        }
    }
}
