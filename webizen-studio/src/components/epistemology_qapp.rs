...
pub fn EpistemologyQapp() -> Element {
    ...
    let theories = ["Foundationalism", "Coherentism", "Reliabilism", "Virtue Epistemology", "Pragmatism", "Contextualism", "Social Epistemology", "Reformed Epistemology", "Feminist", "Evolutionary"];
    let knowledge_types = ["A Priori", "A Posteriori", "Propositional", "Procedural", "Tacit", "Testimonial"];
    let justification_types = ["Internalist", "Externalist", "Evidentialist", "Dogmatist"];
    let challenges = ["Brain-in-Vat", "Dream Argument", "Gettier Problem", "Underdetermination", "Closure Failure"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Epistemology" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Epistemic Theory" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Knowledge Type" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Justification Type" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Sceptical Challenge" }
                    select {
            ...
            div {
                ...
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Proposition" }
                textarea {
                    value: "{proposition}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{epistemic_theory} | {knowledge_type} | {justification_type} | {sceptical_challenge} | Certainty:{certainty}%" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → epistemic engine | justification sieve | knowledge anchor" }
            }
        }
    }
}
