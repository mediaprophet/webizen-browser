...
pub fn ArtsManagementAndAdministrationQapp() -> Element {
    ...
    let org_types = [
        "Museum", "Gallery", "Performing Arts Venue", "Festival",
        "Artist Residency", "Cultural NGO", "Public Arts Agency", "Creative Industry",
    ];
    let domains = [
        "Programming", "Finance", "Marketing", "Development",
        "HR", "Digital Strategy", "Community Engagement", "Grant Writing",
    ];
    let funding_models = [
        "Public", "Private", "Mixed", "Crowdfunded", "Endowment", "Earned Revenue", "Hybrid",
    ];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #94e2d5; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Arts Management & Administration" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Management Domain" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Funding Model" }
                    select {
                        value: "{funding_model}",
            ...
            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Attendance Target" }
                    input {
                        r#type: "number",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Revenue Budget (USD)" }
                    input {
                        r#type: "number",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Earned Revenue % (0–100): {earned_revenue_pct}%" }
                input {
                    r#type: "range",
                    min: "0",
                    max: "100",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{organisation_type} | {management_domain} | {funding_model} | Earned: {earned_revenue_pct}%" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → cultural sector graph | funding model sieve | audience analytics engine" }
            }
        }
    }
}
