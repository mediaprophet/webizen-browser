...
pub fn EnvironmentalHumanitiesQapp() -> Element {
    ...
    let lenses = [
        "Ecocriticism", "Multispecies Studies", "New Materialism", "Political Ecology",
        "Environmental Justice", "Solastalgia", "Cli-fi", "Indigenous Ecological Knowledge",
    ];
    let modes = [
        "Pastoral", "Nature Writing", "Cli-Fi", "Eco-Gothic", "Solarpunk", "Documentary",
    ];
    let scales = ["Local", "Regional", "National", "Global", "Planetary"];
    let frames = ["Holocene", "Anthropocene", "Capitalocene", "Plantationocene", "Deep Time"];
    let media = ["Literature", "Film", "Visual Art", "Music", "Architecture"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Environmental Humanities" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Literary Mode" }
                    select {
                        value: "{literary_mode}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Geographic Scale" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Temporal Frame" }
                    select {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{theoretical_lens} | {temporal_frame} | {geographic_scale} | {medium}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → ecological sieve | multispecies graph | deep time engine" }
            }
        }
    }
}
