...
pub fn MissiologyQapp() -> Element {
    ...
    let traditions = ["Catholic", "Protestant Evangelical", "Ecumenical", "Pentecostal", "Orthodox", "Postcolonial Mission Theory"];
    let models = ["Christendom", "Three-Self Formula", "Contextualisation", "Kingdom Ethics", "Missio Dei", "Integral Mission", "Decolonial Mission"];
    let periods = ["Early Church", "Medieval", "Colonial Missions", "20th C. Ecumenism", "Contemporary"];
    let methods = ["Church Planting", "Medical", "Educational", "Development", "Dialogue", "Witness"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Missiology" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Missiological Model" }
                    select {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{tradition} | {missiological_model} | {historical_period} | {method} | {geographic_focus}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → missiology engine | contextualisation sieve | cross-cultural anchor" }
            }
        }
    }
}
