...
pub fn JournalismQapp() -> Element {
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: #fab387; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Journalism QApp" }

            div { style: "display: flex; flex-direction: column; gap: 8px;",
                label { style: "font-size: 0.85rem; color: #a6adc8;", "Journalism Type" }
                select {
            ...
            div { style: "display: flex; flex-direction: column; gap: 8px;",
                label { style: "font-size: 0.85rem; color: #a6adc8;", "News Value" }
                select {
                    style: "background: #313244; color: #cdd6f4; border: 1px solid #45475a; border-radius: 6px; padding: 6px 8px; font-family: monospace; width: 100%; box-sizing: border-box;",
            ...
            div { style: "display: flex; flex-direction: column; gap: 8px;",
                label { style: "font-size: 0.85rem; color: #a6adc8;", "Ethical Principle" }
                select {
                    style: "background: #313244; color: #cdd6f4; border: 1px solid #45475a; border-radius: 6px; padding: 6px 8px; font-family: monospace; width: 100%; box-sizing: border-box;",
            ...
            div { style: "display: flex; flex-direction: column; gap: 8px;",
                label { style: "font-size: 0.85rem; color: #a6adc8;", "Verification Level (0–100): {verification_level()}%" }
                input {
                    r#type: "range",
                    min: "0",
                    max: "100",
                    ...
                    style: "width: 100%; box-sizing: border-box; accent-color: if verification_level() >= 70 { \"#a6e3a1\" } else { \"#f38ba8\" };",
                    oninput: move |e| verification_level.set(e.value().parse().unwrap_or(70)),
                }
            }

            div { style: "display: flex; flex-direction: column; gap: 8px;",
                label { style: "font-size: 0.85rem; color: #a6adc8;", "Story Pitch" }
                textarea {
            ...
            div {
                ...
                div { style: "font-size: 0.8rem; color: #a6adc8; display: flex; flex-direction: column; gap: 4px;",
                    ...
                    div { style: "color: if verification_level() >= 70 { \"#a6e3a1\" } else { \"#f38ba8\" };", "Verification: {verification_level()}%" }
                }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 8px;", "QualiaDB → epistemic logic | provenance graph | discourse sieve" }
            }
        }
    }
}
