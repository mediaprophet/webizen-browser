...
pub fn CriticalDisabilityStudiesQapp() -> Element {
    ...
    let models = ["Social Model", "Cultural Model", "Crip Theory", "Posthuman Disability", "Biopsychosocial", "Human Rights"];
    let impairment_types = ["Physical", "Sensory", "Cognitive", "Psychiatric", "Chronic Illness", "Multiple"];
    let access_barriers = ["Physical", "Attitudinal", "Communication", "Institutional", "Digital"];
    let legal_frameworks = ["ADA", "CRPD", "Equality Act", "NDIS", "Other"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89b4fa; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Critical Disability Studies" }
            div {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Impairment Type" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Access Barrier" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Legal Framework" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Accessibility Score: {accessibility_score}" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{model} | {impairment_type} | {access_barrier} | {legal_framework} | score: {accessibility_score}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → disability studies engine | discourse sieve | anchor" }
            }
        }
    }
}
