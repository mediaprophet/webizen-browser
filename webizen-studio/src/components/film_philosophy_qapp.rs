...
pub fn FilmPhilosophyQapp() -> Element {
    ...
    let philosophical_traditions = ["Phenomenology", "Analytic", "Continental", "Cognitivism", "Neurophilosophy", "Ethics"];
    let philosopher_filmmakers = ["Deleuze/Tarkovsky", "Cavell/Hollywood", "Bazin/Neorealism", "Merleau-Ponty/Sensory Cinema", "Rancière/Essay Film"];
    let film_concepts = ["Time-Image", "Movement-Image", "Indexicality", "Cinematic Gaze", "Apparatus", "Montage"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Film Philosophy" }
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Philosophical Tradition" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Philosopher-Filmmaker Pair" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Film Concept" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Medium Specificity: {medium_specificity}" }
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Philosophical Depth: {philosophical_depth}" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{philosophical_tradition} | {film_concept} | specificity: {medium_specificity} | depth: {philosophical_depth}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → film philosophy engine | discourse sieve | anchor" }
            }
        }
    }
}
