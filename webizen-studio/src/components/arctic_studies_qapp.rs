...
pub fn ArcticStudiesQapp() -> Element {
    ...
    let regions = ["Alaska", "Canadian Arctic", "Greenland", "Svalbard", "Russian Arctic", "Fennoscandia Arctic"];
    let disciplines = ["Environmental Science", "Anthropology", "History", "Political Science", "Indigenous Studies", "Oceanography"];
    let climate_focuses = ["Sea Ice", "Permafrost", "Arctic Amplification", "Methane Release", "Glacial Retreat"];
    let ik_options = ["None", "Supplementary", "Co-Equal", "Led-By-Community"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #89dceb; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Arctic Studies" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Climate Focus" }
                    select {
                        value: "{climate_focus}",
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Indigenous Knowledge Integration" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Indigenous People" }
                input {
                    r#type: "text",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Temperature Anomaly (°C): {temperature_anomaly_c:.1}" }
                input {
                    r#type: "range",
                    min: "0",
                    max: "10",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{region} | {discipline} | {climate_focus} | +{temperature_anomaly_c:.1}°C | IK: {indigenous_knowledge_integration}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → climate engine | indigenous knowledge sieve | geospatial anchor" }
            }
        }
    }
}
