...
pub fn IdeologyCritiqueQapp() -> Element {
    ...
    let ideological_forms = ["Naturalization", "Universalization", "Legitimation", "Reification", "Hegemony", "Interpellation", "Spectacle"];
    let theorists = ["Althusser", "Gramsci", "Žižek", "Debord", "Hall", "Eagleton", "Butler"];
    let sites = ["Media", "Education", "Law", "Religion", "Science", "Consumer Culture"];
    let critique_methods = ["Immanent Critique", "Symptomatic Reading", "Discourse Analysis", "Deconstruction"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #cba6f7; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Ideology Critique" }
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Ideological Form" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Critique Method" }
                select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Ideology Density: {ideology_density}" }
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{ideological_form} | {theorist} | {site} | {critique_method} | density: {ideology_density}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → ideology critique engine | discourse sieve | anchor" }
            }
        }
    }
}
