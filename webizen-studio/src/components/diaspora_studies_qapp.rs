...
pub fn DiasporaStudiesQapp() -> Element {
    ...
    let diaspora_types = ["Colonial", "Labour Migration", "Refugee", "Voluntary", "Forced Displacement", "Transnational"];
    let regions = ["Africa", "Asia", "Americas", "Europe", "Middle East", "Oceania", "Multiple"];
    ...
    rsx! {
        div {
            ...
            h2 { style: "margin: 0; color: #b4befe; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Diaspora Studies" }

            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Diaspora Type" }
                select {
                    value: "{diaspora_type}",
            ...
            div {
                ...
                div {
                    style: "flex: 1;",
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Origin Region" }
                    select {
                        value: "{origin_region}",
                ...
                div {
                    style: "flex: 1;",
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Host Region" }
                    select {
                        value: "{host_region}",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Generation" }
                select {
                    value: "{generation}",
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Cultural Retention: {cultural_retention}%" }
                input {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Remittance Flow $B: {remittance_flow:.1}" }
                input {
                    r#type: "range", min: "0", max: "100",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{diaspora_type} | {origin_region} → {host_region} | Gen: {generation} | Retention: {cultural_retention}% | ${remittance_flow:.1}B" }
