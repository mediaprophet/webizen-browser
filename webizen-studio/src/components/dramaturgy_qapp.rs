...
pub fn DramaturgyQapp() -> Element {
    ...
    let production_types = ["New Play Development", "Classical Revival", "Devised", "Musical", "Opera", "Physical Theatre", "Site-Specific"];
    let dramaturgical_roles = ["Conceptual", "Research", "Script Editing", "Audience Advocacy", "Production Dramaturgy", "Literary Manager"];
    let lenses = ["Brechtian", "Stanislavski", "Artaudian", "Postdramatic", "New Dramaturgies", "Feminist"];
    let analysis_methods = ["Action", "Super-Objective", "Given Circumstances", "Beats", "Spine"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #a6e3a1; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Dramaturgy" }

            div {
                style: "display: grid; grid-template-columns: 1fr 1fr; gap: 12px;",
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Production Type" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Dramaturgical Role" }
                    select {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Script Analysis Method" }
                    select {
            ...
            div {
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Research Area" }
                input {
                    r#type: "text",
                    value: "{research_area}",
            ...
            div {
                ...
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Production Notes" }
                textarea {
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{production_type} | {dramaturgical_role} | {theoretical_lens} | {script_analysis_method}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → dramaturgy engine | script analysis sieve | theatre history anchor" }
            }
        }
    }
}
