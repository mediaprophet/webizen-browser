...
pub fn RomanceLanguagesAndLiteraturesQapp() -> Element {
    ...
    let languages = ["French", "Spanish", "Portuguese", "Italian", "Romanian", "Catalan", "Occitan", "Galician", "Sardinian"];
    let periods = ["Vulgar Latin", "Medieval", "Renaissance", "Classical", "Romantic", "Realist", "Modernist", "Contemporary"];
    let genres = ["Chanson de Geste", "Troubadour Lyric", "Novel", "Drama", "Essay", "Poetry"];
    let movements = ["Trobar", "Dolce Stil Novo", "Petrarchism", "Picaresque", "Romanticism", "Realism", "Surrealism", "Magical Realism"];

    rsx! {
        div {
            style: "padding: 20px; background: #1e1e2e; color: #cdd6f4; border-radius: 12px; font-family: monospace; display: flex; flex-direction: column; gap: 16px; height: 100%; box-sizing: border-box;",
            h2 { style: "margin: 0; color: #fab387; border-bottom: 1px solid #313244; padding-bottom: 8px;", "Romance Languages & Literatures" }
            ...
            div {
                ...
                div {
                    label { style: "font-size: 0.8rem; color: #a6adc8;", "Literary Movement" }
                    select {
            ...
            div {
                ...
                label { style: "font-size: 0.8rem; color: #a6adc8;", "Text Excerpt" }
                textarea {
                    value: "{text_excerpt}",
            ...
            div {
                ...
                span { style: "font-size: 0.8rem; color: #a6adc8;", "{language} | {period} | {genre} | {literary_movement}" }
                div { style: "font-size: 0.75rem; color: #585b70; margin-top: 6px;", "QualiaDB → romance corpus | literary movement sieve | philological engine" }
            }
        }
    }
}
